<template>
  ...
  >
    <div
      class="relative h-48 flex-none flex flex-row self-stretch justify-between items-center gap-2"
    >
      <div class="flex-1 text-3xl text-center" v-text="appliance.nickname" />
      <div
        class="absolute inset-0 m-auto left-auto flex-none w-64 h-64 dark:text-gray-200/50"
